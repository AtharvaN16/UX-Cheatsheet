  ...
  return (
    <div className="mt-8 space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Right Action Controls: Filter & Sort Popover Dropdown & Grid/List View Toggle */}
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {/* Floating Popover Dropdown (Does NOT push screen content down) */}
            {isFilterOpen && (
              <>
                ...
                {/* Floating Card Modal Overlay matching reference image */}
